...
public class BinTreeTester {
    ...
    public static void main(String[] args) {
        ...
        //정수의 오림차순으로 순서매기기를 수행하는 comparator
        final IntegerDecComparator DEC_COMPARATOR = new IntegerDecComparator();
        BinTree<Integer, Data> tree = new BinTree<>(DEC_COMPARATOR);
